                ...
                <section id="responsive-datatable">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('schedule-doctor.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" name="start_time" value="{{ old('start_time', '') }}" id="fp-time"
                                                                class="form-control text-start bg-white flatpickr-time text-start flatpickr-input" tabindex="2" placeholder="HH:ii" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" name="end_time" value="{{ old('end_time', '') }}" id="fp-time"
                                                                class="form-control text-start bg-white flatpickr-time text-start flatpickr-input" tabindex="3" placeholder="HH:ii" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
